...
public class GerenciarEventoController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        //  Tudo que é do formulário envelopado aqui
    ...
    private void editarEvento(Evento evento) {
        try {
            ...
            AlertManager.exibirAlerta(Alert.AlertType.INFORMATION, "Permissão Negada", e.getMessage());
        }
    }
    ...
    public void novoEvento() {
        try {
            ScreenManager.getInstancia().irParaFormularioEvento(null);
        } catch (PermissaoNegadaException e) {
            AlertManager.exibirAlerta(Alert.AlertType.INFORMATION, "Permissão Negada", e.getMessage());
        }
    }
